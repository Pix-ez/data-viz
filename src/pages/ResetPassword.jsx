...
function ResetPassword() {
  ...
  const Submit = (e) => {
    e.preventDefault();
    axios.post('http://localhost:3001/users/forget-password', formData, {
        ...
        <section className="relative">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              { status ? ( <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <h1 className="h1 mb-4">Done</h1>
                <p className="text-xl text-gray-400">Password reset link is sent to the email you provided ✌️.</p>
                <button className="btn text-white bg-purple-600 hover:bg-purple-700 w-full"
                    onClick={()=>{setStatus(false)}}>Change email</button>
