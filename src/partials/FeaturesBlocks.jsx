        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Create Project file</h4>
              <p className="text-lg text-gray-400 text-center">User can create project file and it will be saved. User can 
              open and remove it.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Visualize data easily </h4>
              <p className="text-lg text-gray-400 text-center">User can easily visualize the data in forms of graphs and charts. Interactive graphs and charts.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Upload data</h4>
              <p className="text-lg text-gray-400 text-center">User can upload the data file and dataset in form of execl csv file.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Create and store insights</h4>
              <p className="text-lg text-gray-400 text-center">User can find insights in data and write it down and save.</p>
            </div>
