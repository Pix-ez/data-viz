...
function Header() {
  ...
  const [username, setUsername] = useState('U have to login');
  ...
  const logOut = () => {
    ...
    localStorage.setItem('loggedIn', 'false'); // fix here, set the value as a string
    setUsername("U have to login");
    setLoginStatus(false); // add this line to update the state
  }
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              ...
              {localStorage.getItem('loggedIn') === null || localStorage.getItem('loggedIn') === 'false' ? 
                 <li>
                 <Link to="/signin" className="font-medium text-purple-600 hover:text-gray-200 px-4 py-3 flex items-center transition duration-150 ease-in-out">Log in</Link>
               </li> : null}
              ...
              {localStorage.getItem('loggedIn') === 'true' ? 
                ...
                <a className="btn-sm text-white bg-purple-600 hover:bg-purple-700 ml-3" onClick={() => logOut()}>Log out</a>
          ...
          <div className="md:hidden">
            ...
            <nav id="mobile-nav" ref={mobileNav} className="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" style={mobileNavOpen ? { maxHeight: mobileNav.current.scrollHeight, opacity: 1 } : { maxHeight: 0, opacity: .8 } }>
              <ul className="bg-gray-800 px-4 py-2">
               ...
               <li>
               <Link to="/signin" className="flex font-medium w-full text-purple-600 hover:text-gray-200 py-2 justify-center">Log in</Link>
             </li> 

           
                <li>
                  <Link to="/signin" className="flex font-medium w-full text-purple-600 hover:text-gray-200 py-2 justify-center">Log Out</Link>
                </li> 
                ...
                <li>
                  ...
                  justify-center border border-transparent px-4 py-2 my-2 rounded-sm text-white bg-purple-600 hover:bg-purple-700
